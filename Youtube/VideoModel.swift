...
class VideoModel: NSObject {
    ...
    let CHANNEL_ID = "UCuP2vJ6kRutQBfRmdcI92mA"
    ...
    var delegate: VideoModelDelegate?
     ...
     //Fetch the videos dynamically from Youtube API
        ...
        Alamofire.request("https://www.googleapis.com/youtube/v3/playlistItems", method: HTTPMethod.get, parameters: ["part":"snippet", "playlistId":"PL0dzCUj1L5JGfHj1lwxOq67zAJV3e1S9S","key": API_KEY, "channelId": CHANNEL_ID], encoding: URLEncoding.default, headers: nil).responseJSON {(response) in
        print(response)
